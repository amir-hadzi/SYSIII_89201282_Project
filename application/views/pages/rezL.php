...
<ul>
  ...
  <li><a href="./rezLS">Slovene/Slovenščina</a></li>
</ul>
<br><br><br><br>
...
<h1 class="text-center">Result </h1>
            ...
            <tr>
                <td>Departure</td><td>Destination</td><td>Cost</td><td>Departure Time</td><td>Arrival Time</td><td>Reserve</td>
            </tr>
        <?php //to extract the fav from the database and appear them in the table
            ...
            if($num = mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_assoc($result)){
                    echo "
                    <tr>
                        <td>".$row['Source']." </td> <td> ".$row['Dest']."</td><td> ".$row['Cost']."</td><td> ".$row['DepTime']."</td><td> ".$row['ArrTime']."</td><td><form method='post'> <button class='btn btn-primary btn-block' type='submit' name='button1' value='".$row['RouteID']."'>Reserve</button></form></td>
                ...
                echo "
                    <tr>
                        <td colspan = '4'>There are no Routes for given parameters</td>
                    </tr>
                ";
            }            
	...
	$sql = "SELECT * FROM Route WHERE RouteID = '".$_POST["button1"]."'";
        ...
        ?>
					...
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './index';">Search</button>
                        </div>
                    </div>
                </div>
