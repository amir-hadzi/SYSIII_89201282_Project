...
<div class="container">
        ...
        ?>
					...
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './rezL';">Go back</button>
					<br>
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './payment';">Pay</button>
                        </div>
                    </div>
                </div>
            </div>
