...
<head>
  <meta charset="UTF-8">
  <title>Plaćanje s kreditno kartico</title>
<style>
body {
  background: #307B75;
}
...
<ul>
   ...
   <li><a href="./payment">English/Angleščina</a></li>
</ul>
<br><br>
<div class="checkout">
  <h1>
    Plaćanje s kreditno kartico
  </h1>
  <form method="post">
    ...
    <button type="submit" name="button1">Plati</button>
  </form>
</div>
  <footer>
