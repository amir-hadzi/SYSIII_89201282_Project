...
<ul>
  ...
  <li><a href="./LoginS">Slovene/Slovenščina</a></li>


</ul>
<div class="pt-5">
<h1 class="text-center">You provided wrong login information</h1>
<div class="container">
                <div class="row">
							   ...
							   <div class="form-group required">
                                ...
                                <div class="form-group required">
                                    <label class="d-flex flex-row align-items-center" for="password">Password 
                                        <a class="ml-auto border-link small-xl" href="./ForgotPWD">Forget?</a></label>
                                    <input type="password" class="form-control"  id="password" name="pwd" required="">
                                </div>
                               
                                <div class="form-group pt-1">
                                    <button class="btn btn-primary btn-block" type="submit" name="button1">Log In</button>
                                </div>
                            </form>
                            <p class="small-xl pt-3 text-center">
                                <span class="text-muted">Not a member?</span>
                                <a href="./SignUpL">Sign up</a>
                            </p>
                        </div>
                    </div>
                </div>
