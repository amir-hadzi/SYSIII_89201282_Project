...
<br>
<div class="pt-5">
<h1 class="text-center">You have purchased it successfuly </h1>
<div class="container">
                <div class="row">
        ...
        ?>
					...
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './index';">Home</button>
					<br>
