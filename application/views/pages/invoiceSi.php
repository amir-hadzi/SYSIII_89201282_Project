...
<ul>
   ...
   <li><a href="./invoice">English/Angleščina</a></li>
</ul>
<br>
<div class="pt-5">
<h1 class="text-center">Račun </h1>
<div class="container">
                <div class="row">
        ...
        ?>
					...
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './rezLS';">Nazaj</button>
					<br>
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './paymentS';">Plati</button>
                        </div>
                    </div>
                </div>
            </div>
