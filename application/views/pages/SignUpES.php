...
<ul>
  <li><a href="./indexS">Začetna stran</a></li>
   <li><a href="./SignUpE">English/Angleščina</a></li>
 
</ul>
<div class="pt-5">
<h1 class="text-center">E-pošta, ki ste jo zagotovili, je že registrirana</h1>
<div class="container">
                <div class="row">
                            ...
                            <form id="submitForm"  method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1"><input type="hidden" name="_csrf" value="7635eb83-1f95-4b32-8788-abec2724a9a4">
							  ...
							  <div class="form-group required">
                                ...
                                <div class="form-group pt-1">
                                    <button class="btn btn-primary btn-block" type="submit" name="button1">Registracija</button>
                                </div>
