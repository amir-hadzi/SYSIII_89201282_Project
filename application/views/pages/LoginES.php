...
<ul>
 <li><a href="./indexS">Začetna stran</a></li>
   <li><a href="./LoginE">English/Angleščina</a></li>


</ul>
<div class="pt-5">
<h1 class="text-center">Predložili ste napačne podatke za prijavo</h1>
<div class="container">
                <div class="row">
							   ...
							   <div class="form-group required">
                                ...
                                <div class="form-group required">
                                    <label class="d-flex flex-row align-items-center" for="password">Geslo 
                                        <a class="ml-auto border-link small-xl" href="./ForgotPWDS">Pozabili?</a></label>
                                    <input type="password" class="form-control"  id="password" name="pwd" required="">
                                </div>
                               
                                <div class="form-group pt-1">
                                    <button class="btn btn-primary btn-block" type="submit" name="button1">Prijavo</button>
                                </div>
                            </form>
                            <p class="small-xl pt-3 text-center">
                                <span class="text-muted">Ni član?</span>
                                <a href="./SignUpLS">Registracijo</a>
                            </p>
                        </div>
                    </div>
                </div>
