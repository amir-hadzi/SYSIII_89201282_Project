...
<ul>
  <li><a href="./indexS">Začetna stran</a></li>
   <li><a href="./rezL">English/Angleščina</a></li>
</ul>
<br><br><br><br>
...
<h1 class="text-center">Rezultati </h1>
	...
	$sql = "SELECT * FROM Route WHERE RouteID = '".$_POST["button1"]."'";
        ...
        ?>
					...
					<button class='btn btn-primary btn-block' type='submit' value='Back' onclick="window.location.href = './indexS';">Pretraga</button>
                        </div>
                    </div>
                </div>
